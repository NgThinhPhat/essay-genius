...
public class EssayController {
    ...
    public ResponseEntity<EssayResponseWrapper<?>> scoring(@Valid @RequestBody EssayTaskTwoScoringRequest essayScoringRequest) throws Exception {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<EssayResponseWrapper<String>> generateEssayPrompt(@RequestBody List<String> topic) throws Exception {
        return ResponseEntity.ok()
    ...
    public ResponseEntity<CommonResponse> saveEssay(@Valid @RequestBody EssaySaveRequest essaySaveRequest) throws Exception {
